...
function App() {
  ...
  const buttonList = [
    ...
    {name: "next", behavior: () => {
      ...
      images[position].ref.current.scrollIntoView({
      behavior : 'smooth',
      block : 'nearest',
      inline:'center'
    });}}
  ...
  //<CheckBox checked={horizontal} message="Horizontal" onChange={event => setHorizontal(event.target.checked)} ref={checkbox} />
  return (
